       ...
       <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 min-h-screen w-full overflow-y-auto">
         ...
         <div className="py-8 px-4 mx-auto max-w-2xl lg:py-16">
             ...
             <div className="flex items-center space-x-4">
                 ...
                 <button type="button" className="inline-flex items-center text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" onClick={()=>nav(`/genextpdf/${transaction_id}`)}>
                        <DocumentScanner/>
                        Generate PDF
                </button> 
