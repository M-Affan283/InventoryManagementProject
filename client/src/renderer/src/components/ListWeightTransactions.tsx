...
const ListWeightTransactions = () => {
    ...
    const fetchData = async (searchQuery) =>
    {
        try
        {
            axios.get(`${apiUrl}/goods/getWeighingTransactions`, {params: {email: user?.email ,searchQuery: searchQuery, page: page, pageSize: pageSize}})
            .then((res)=>
            {
    ...
    const transaction_columns = [
        ...
        },
        {
          ...
          Cell: ({row}) => (
            <p className="">
                <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={()=>nav(`/individualweighttransaction/${row.original._id}`)}>View</button>
            </p>
          )
        }
      ]
...
export default ListWeightTransactions