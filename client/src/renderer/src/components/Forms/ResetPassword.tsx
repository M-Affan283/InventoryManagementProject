...
const ResetPassword = () => {
    ...
    const formSubmit = (e:any) =>
    {
        ...
        try
        {
            axios.post(`${apiUrl}/user/resetPassword`, {email, newPassword})
            .then((res)=>
            {
            ...
            {
                console.log(error);
                setServerResponse({message: error.response.data.message, status: 400});
                closeForm();
            })
        ...
        {
            console.log(error);
            setServerResponse({message: "Server Error", status: 400});
            closeForm();
        }
    }
  ...
  return (
    <div>
            ...
            <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Reset an employee password.</p>
