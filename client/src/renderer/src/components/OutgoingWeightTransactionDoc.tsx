...
const generateDocument = (transaction) =>
{
  ...
  const {_id = '', type = '', truck_no = '', driver_name = '', driver_contact = '', vendor = '', goods_type_id = {}, truck_weight = 0, container_weight = 0, goods_weight = 0, date_empty_weight, date_filled_weight, employee = {}, is_deleted = false, delete_by = '',delete_reason = '', date_deleted} = transaction;
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>Truck Weight: {truck_weight} kg</Text>
          <Text style={styles.text}>Container Weight: {container_weight} kg</Text>
...
const OutgoingWeightTransactionDoc = () => {
...
export default OutgoingWeightTransactionDoc